...
public class TC04 extends AkeoSanityTestBase {

	static Logger logTC_04 = Logger.getLogger(TC04.class);

	@Test(description = "Checkout Journey using Tyres alongwith other products with premium service.")
	public static void TestCase4() throws Exception {
		...
		addbasket.DetailPageSelectAddProduct(3).AddtoBasket()
