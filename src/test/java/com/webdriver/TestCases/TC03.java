...
public class TC03 extends AkeoSanityTestBase {

	static Logger logTC_03 = Logger.getLogger(TC03.class);

	@Test(description = "Checkout Journey using Only Tyres.")
	public static void TestCase3() throws Exception {
		...
		addbasket.DetailPageSelectAddProduct(1).AddtoBasket()
